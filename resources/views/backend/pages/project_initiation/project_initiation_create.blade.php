...
@section("content")
    ...
    <div class="container">
        ...
        <form class="form_create" action="{{ route("project_initiation.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="required_file" name="required_file">
