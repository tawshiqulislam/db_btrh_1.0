...
@section("content")
    ...
    <div class="container">
        ...
        <form class="form_create" action="{{ route("user.update", $user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                ...
                {{-- <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="sq_no_1" id="sq_no_1" class="form-control">
                            <option value="{{ $user->sq_no_1 }}">{{ $user->sq_no_1 }}</option>
                ...
                {{-- <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="sq_no_2" id="sq_no_2" class="form-control">
                            <option value="{{ $user->sq_no_2 }}">{{ $user->sq_no_2 }}</option>
                            @foreach ($security_questions as $security_question)
                                <option value="{{ $security_question->name }}">{{ $security_question->name }}</option>
                            @endforeach
                        </select>
